...
function HobbiesList({ todoList, setTodoList, token, userId, notify }) {
	...
	const handleSubmit = (e) => {
		...
		fetch(todoListRoutes.addTeamHobbies, {
			method: "POST",
			headers: {
	...
	const handelCreateDailyTask = (e) => {
		...
		let teamId = todoList.hobbiesList[activeTeamId]._id;
					...
					<div>
						<section>
							<div>
								...
								>
									{todoList.hobbiesList.map((team, index) => (
								...
								{activeTeamId !== "create" &&
								todoList.hobbiesList[activeTeamId].isPublic ? (
									<div
									...
									>
										...
										<p style={{ fontSize: "20px" }}>
											{todoList.hobbiesList[activeTeamId].allMembers
												.length + 1}
										</p>
									</div>
								) : (
							...
							{activeTeamId !== "create" &&
							todoList.hobbiesList[activeTeamId].createdBy.creatorId ===
								userId ? (
								<div
									style={{
										display: "flex",
							...
							<div>
								<section id="teamDetails">
									...
									>
										...
										<div className="users" ref={usersContainerRef}>
											...
											{todoList.hobbiesList[activeTeamId].createdBy
												.creatorId !== userId && (
												<div
													key={
														todoList.hobbiesList[activeTeamId]
															.createdBy.creatorId
													}
													style={{
														margin: "10px",
								...
								<section id="tasks">
									<DailyTasks
										...
										dailyTasks={
											todoList.hobbiesList[activeTeamId].dailyTasks
										}
										creatorId={
											todoList.hobbiesList[activeTeamId].createdBy
												.creatorId
									...
									<Reminder
										interpolateColor={interpolateColor}
										reminders={
											todoList.hobbiesList[activeTeamId].reminders
										}
										creatorId={
											todoList.hobbiesList[activeTeamId].createdBy
												.creatorId
									...
									<TeamUpdates
										updates={todoList.hobbiesList[activeTeamId].updates}
										creatorName={
											todoList.hobbiesList[activeTeamId].createdBy
												.creatorName
										}
										createdAt={
											todoList.hobbiesList[activeTeamId].createdAt
										}
										userId={userId}
										formData={formData}
								...
								<section id="task-goal">
									<Tasks
										interpolateColor={interpolateColor}
										tasks={todoList.hobbiesList[activeTeamId].tasks}
										creatorId={
											todoList.hobbiesList[activeTeamId].createdBy
												.creatorId
										}
									...
									<Goal
										interpolateColor={interpolateColor}
										goals={todoList.hobbiesList[activeTeamId].goals}
										creatorId={
											todoList.hobbiesList[activeTeamId].createdBy
												.creatorId
										}
										teamId={todoList.hobbiesList[activeTeamId]._id}
										userId={userId}
										token={token}
										notify={notify}
