						...
						{activeTeamId !== "create" ? (
							<div>
								...
								<section id="tasks">
									...
									<TeamUpdates
										updates={todoList.workList[activeTeamId].updates}
										creatorName={
											todoList.workList[activeTeamId].createdBy
												.creatorName
										}
								...
								<section id="task-goal">
									<Tasks
										interpolateColor={interpolateColor}
										tasks={todoList.workList[activeTeamId].tasks}
										creatorId={
											todoList.workList[activeTeamId].createdBy
												.creatorId
										}
									...
									<Goal
										interpolateColor={interpolateColor}
										goals={todoList.workList[activeTeamId].goals}
										creatorId={
											todoList.workList[activeTeamId].createdBy
												.creatorId
										}
										teamId={todoList.workList[activeTeamId]._id}
										userId={userId}
										token={token}
										notify={notify}
