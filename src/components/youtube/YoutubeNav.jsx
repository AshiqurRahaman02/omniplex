...
function YoutubeNav({currentColor,setSideBarVisible,isSignedIn}) {
  ...
  return (
    <nav style={{
        ...
        <div id="start">
            ...
            <div id="logo" onClick={()=>navigate("/youtube")}>
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="external-icon"
                    viewBox="0 0 90 20"
        ...
        <div id="center">
            <div id="search">
                ...
                <div
                    id="search-icon"
                    style={{
                        border: `.5px solid var(--color-light-${currentColor})`,
                        backgroundColor: `var(--color-light-${currentColor})`,
                    }}
