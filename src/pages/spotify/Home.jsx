...
function Home() {
	...
	const [song, setSong] = useState({
		src: "/assets/spotify/Dil Haareya.mp3",
		img:"https://i.scdn.co/image/ab67616d00001e02a24f426a3301ef2ad197f453",
		name:"Dil Haareya",
		owner:"Arijit Singh"
	});
		...
		<div className="spotify">
			<div>
				...
				<div id="spotify-main">
					...
					{displayCollection ? (
						<div>
							<Collection collection={playlistCollection} setSong={setSong} setIsPlaying={setIsPlaying}/>
						</div>
					) : displayArtist ? (
						<Artist
							artist={artist}
